...
(function() {
  ...
  function showApiKeyPrompt() {
    ...
    message.innerHTML = `
      <div class="notification-content">
        ...
        <p>please configure your claude api key in the extension settings.</p>
  ...
  async function generateContent() {
    try {
      ...
      const mainPostResponse = await browser.runtime.sendMessage({
      ...
      if (!mainPostResponse.success) {
        throw new Error(mainPostResponse.error || 'Failed to generate main post');
      }
  ...
  function displayContent() {
    ...
    html += `
      <div class="content-section">
        ...
        <div class="content-preview" id="mainPostPreview">${escapeHtml(generatedContent.mainPost)}</div>
      </div>
    `;
      ...
      generatedContent.replies.forEach((reply, index) => {
        html += `
          <div class="content-section">
            ...
            <div class="content-preview" id="reply${index}Preview">${escapeHtml(reply.content)}</div>
          </div>
        `;
      });
    }
